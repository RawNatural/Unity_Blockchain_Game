...
public class SendMint : MonoBehaviour
{
    string contract;
    string uri;
    //constructor
    public SendMint(string contract, string uri)
    {
    ...
    async public void OnSendContract()
    {
        ...
        // address of contract
        // OLD VERSION string contract = "0x99Ada1af5bc9Bce1b2b2B80C8d0E3ABF9cc18057";
        // NEW VERSION just lets contract be made in constructor above (uses different contracts because this seperates the NFTs into groups in openseas etc.
        // address of person to mint NFT to
        string account = PlayerPrefs.GetString("Account");
        print("player account = " + account);
        // array of arguments for contract
        string args = "[\"" + account + "\", \"" + uri + "\"]";
        // value in wei
        string value = "0";
        // gas limit OPTIONAL
        string gasLimit = "602000";
        // gas price OPTIONAL
        string gasPrice = "";
